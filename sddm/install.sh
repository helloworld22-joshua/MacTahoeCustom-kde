...
install () {
  ...
  sudo cp -r "${REO_DIR}/images/Background${color}.jpeg" "${THEME_DIR}/${name}${color}/Background.jpeg"
  sudo cp -r "${REO_DIR}/images/Preview${color}.jpeg" "${THEME_DIR}/${name}${color}/Preview.jpeg"
